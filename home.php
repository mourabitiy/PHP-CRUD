...
<nav class="navbar navbar-light navbar-expand-lg navigation-clean">
    ...
    <a href="liste.php"  class="btn btn-danger"  style="border:none;width:151px;height:58px;margin-left:14px;background-color:#a0c65d;">
    Liste des étudiants
    </a>
            <a class="btn btn-danger"
            href = "ajouter.php"
            style="border:none;width:151px;height:58px;margin-left:14px;background-color:#4bc4e0;">Ajouter
            un étudiant</a></div>
